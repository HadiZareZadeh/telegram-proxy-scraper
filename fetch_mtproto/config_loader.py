...
_FIELD_MAP: tuple[tuple[str, str, str], ...] = (
    ...
    ("v2ray", "catalog_max", "V2RAY_CATALOG_MAX"),
    ("v2ray", "tcp_concurrency", "V2RAY_TCP_CONCURRENCY"),
    ("v2ray", "tcp_timeout", "V2RAY_TCP_TIMEOUT"),
    ("scraper", "proxy_check_interval", "PROXY_CHECK_INTERVAL"),
    ("scraper", "reconnect_delay", "RECONNECT_DELAY"),
    ("url_sources", "enabled", "URL_SOURCES_ENABLED"),
    ("url_sources", "urls_file", "URL_SOURCES_FILE"),
    ("url_sources", "fetch_interval", "URL_SOURCES_FETCH_INTERVAL"),
    ("url_sources", "fetch_timeout", "URL_SOURCES_FETCH_TIMEOUT"),
    ("url_sources", "concurrency", "URL_SOURCES_CONCURRENCY"),
    ...
    ("gui", "auto_start_ping_v2ray", "GUI_AUTO_START_PING_V2RAY"),
    ...
    ("proxy_pool", "socks_start_port", "PROXY_POOL_SOCKS_START_PORT"),
    ("proxy_pool", "http_start_port", "PROXY_POOL_HTTP_START_PORT"),
    ("proxy_pool", "xray_api_port", "PROXY_POOL_XRAY_API_PORT"),
    ("proxy_pool", "stats_port", "PROXY_POOL_STATS_PORT"),
    ...
    ("proxy_pool", "min_reuse_sec", "PROXY_POOL_MIN_REUSE_SEC"),
    ("proxy_pool", "max_latency_ms", "PROXY_POOL_MAX_LATENCY_MS"),
    ("proxy_pool", "random", "PROXY_POOL_RANDOM"),
    ("proxy_pool", "standby_outbounds", "PROXY_POOL_STANDBY_OUTBOUNDS"),
    ("proxy_pool", "reserve_outbounds", "PROXY_POOL_RESERVE_OUTBOUNDS"),
    ("proxy_pool", "rotate_mode", "PROXY_POOL_ROTATE_MODE"),
    ("proxy_pool", "rotate_existing_connections", "PROXY_POOL_ROTATE_EXISTING_CONNECTIONS"),
    ("proxy_pool", "diversity_rotate_sec", "PROXY_POOL_DIVERSITY_ROTATE_SEC"),
    ("hot_set", "size", "HOT_SET_SIZE"),
    ("hot_set", "refresh_sec", "HOT_SET_REFRESH_SEC"),
    ("hot_set", "max_latency_ms", "HOT_SET_MAX_LATENCY_MS"),
    ("hot_set", "freshness_sec", "HOT_SET_FRESHNESS_SEC"),
)
