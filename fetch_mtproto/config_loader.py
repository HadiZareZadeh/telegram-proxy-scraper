...
_FIELD_MAP: tuple[tuple[str, str, str], ...] = (
    ...
    ("xray", "bin", "XRAY_BIN"),
    ("xray", "tun_switch_interval", "XRAY_TUN_SWITCH_INTERVAL"),
    ("xray", "tun_server_limit", "XRAY_TUN_SERVER_LIMIT"),
    ("xray", "tun_reuse_cooldown", "XRAY_TUN_REUSE_COOLDOWN"),
    ("xray", "tun_name", "XRAY_TUN_NAME"),
    ("xray", "tun_mtu", "XRAY_TUN_MTU"),
